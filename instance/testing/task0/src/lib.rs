...
#[wasm_bindgen]
pub fn library_main() {
    println!("Hello from library main");
}
...
impl<I: Clone> LinkedList<I> {
    ...
    pub fn insert_at(&mut self, item: I, position: usize) -> Result<(), String> {
        if position == 0 {
    ...
    pub fn remove(&mut self, position: usize) -> Result<Box<LinkedListNode<I>>, String> {
